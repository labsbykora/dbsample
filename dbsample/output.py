...
import psycopg
from dbsample.schema import Table
from dbsample.sampling import SamplingResult
...
class SQLOutputGenerator:
    ...
    def _write_header(self, output: TextIO):
        ...
        output.write("-- ============================================================================\n")
        output.write("-- Database Sample Export\n")
        output.write(f"-- Generated by dbsample v{version}\n")
